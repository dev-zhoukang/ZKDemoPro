...
#import "ZKOptionBarView.h"
#import "ZKTimelineCommentView.h"

@interface ZKTimelineCell()

@property (nonatomic, strong) ZKTimelineCellLayout *modelLayout;

@property (nonatomic, strong) UIImageView *iconView;
@property (nonatomic, strong) YYLabel *nameLabel;
@property (nonatomic, strong) YYLabel *contentLabel;
@property (nonatomic, strong) ZKImageLayoutView *imageLayoutView;
@property (nonatomic, strong) ZKOptionBarView *optionBarView;
@property (nonatomic, strong) YYLabel *locationLabel;
@property (nonatomic, strong) YYLabel *timeLabel;
@property (nonatomic, strong) ZKTimelineCommentView *commentView;
...
+ (instancetype)cellWithTableView:(UITableView *)tableView {
    static NSString *cellID = @"ZKTimelineCell";
    ZKTimelineCell *cell = [tableView dequeueReusableCellWithIdentifier:cellID];
    if (!cell) {
        cell = [[ZKTimelineCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellID];
...
- (void)setup {
    ...
    _contentLabel.highlightTapAction = ^(UIView *containerView, NSAttributedString *text, NSRange range, CGRect rect) {
        ...
        [ZKRegularTool handleClickRegularTextWithInfo:highlight.userInfo];
    };
    ...
    _imageLayoutView = [ZKImageLayoutView new];
    ...
    _optionBarView = [[ZKOptionBarView alloc] init];
    ...
    _commentView = [ZKTimelineCommentView new];
...
- (void)updateUI:(ZKTimelineCellLayout *)layout {
    _contentLabel.textLayout = layout.textLayout;
    
    ZKUser *fromUser = layout.timelineModel.fromUser;
    NSString *avatar = [fromUser.avatarStr avatarStrWithUid:fromUser.uid];
...
/*! 更新布局 */
- (void)updateLayout:(ZKTimelineCellLayout *)layout {
    _modelLayout = layout;
