...
@interface USTimelineCommentCellLayout()

@property (nonatomic, strong) USComment *comment;
...
@implementation USTimelineCommentCellLayout
...
- (NSMutableAttributedString *)matchText:(NSString *)string {
    ...
    attributedString = [USRegularTool matchAttributedText:attributedString highlightColor:nil];
...
- (NSMutableAttributedString *)matchCommentLabelWithString:(NSString *)commentString
{
    ...
    attributedString = [USRegularTool matchAttributedText:attributedString];
