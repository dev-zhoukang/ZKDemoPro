...
+ (NSMutableAttributedString *)matchText:(NSMutableAttributedString *)text
    ...
    NSRegularExpression *regular = [USRegularTool regularEmotion];
    ...
    // 匹配网址
    NSArray *urlResults = [[USRegularTool regularWebUrl] matchesInString:text.string options:kNilOptions range:NSMakeRange(0, text.string.length)];
    ...
    // 匹配手机
    NSArray *telResults = [[USRegularTool regularMobileNumber] matchesInString:text.string options:kNilOptions range:NSMakeRange(0, text.string.length)];
    ...
    // 匹配座机
    NSArray *phoneResults = [[USRegularTool regularPhoneNumber] matchesInString:text.string options:kNilOptions range:NSMakeRange(0, text.string.length)];
