...
#import "ZKCommentBarView.h"

@interface ZKCommentBarView() <YYTextViewDelegate>
...
@implementation ZKCommentBarView
...
+ (void)show {
    ZKCommentBarView *barView = [[ZKCommentBarView alloc] init];
