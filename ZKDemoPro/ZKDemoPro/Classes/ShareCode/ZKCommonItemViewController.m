...
@interface ZKCommonItemViewController () <UITableViewDelegate, UITableViewDataSource>

@end

@implementation ZKCommonItemViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell updateWithDict:_dataSource[indexPath.section][indexPath.item]];
    return cell;
}
